...
export type FavoriteWhereInput = {
  ...
  id_favorite?: Prisma.IntFilter<"Favorite"> | number
  text?: Prisma.StringFilter<"Favorite"> | string
  author?: Prisma.StringFilter<"Favorite"> | string
  userId?: Prisma.IntFilter<"Favorite"> | number
  user?: Prisma.XOR<Prisma.UserScalarRelationFilter, Prisma.UserWhereInput>
}

export type FavoriteOrderByWithRelationInput = {
  id_favorite?: Prisma.SortOrder
...
export type FavoriteScalarWhereWithAggregatesInput = {
  ...
  id_favorite?: Prisma.IntWithAggregatesFilter<"Favorite"> | number
  text?: Prisma.StringWithAggregatesFilter<"Favorite"> | string
  author?: Prisma.StringWithAggregatesFilter<"Favorite"> | string
...
export type FavoriteUncheckedUpdateInput = {
  id_favorite?: Prisma.IntFieldUpdateOperationsInput | number
  text?: Prisma.StringFieldUpdateOperationsInput | string
  author?: Prisma.StringFieldUpdateOperationsInput | string
...
export type FavoriteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id_favorite" | "text" | "author" | "userId", ExtArgs["result"]["favorite"]>
...
export interface FavoriteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `id_favorite`
   * const favoriteWithId_favoriteOnly = await prisma.favorite.findMany({ select: { id_favorite: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Favorites and only return the `id_favorite`
   * const favoriteWithId_favoriteOnly = await prisma.favorite.createManyAndReturn({
   *   select: { id_favorite: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more Favorites and only return the `id_favorite`
   * const favoriteWithId_favoriteOnly = await prisma.favorite.updateManyAndReturn({
   *   select: { id_favorite: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface FavoriteFieldRefs {
  readonly id_favorite: Prisma.FieldRef<"Favorite", 'Int'>
  readonly text: Prisma.FieldRef<"Favorite", 'String'>
  readonly author: Prisma.FieldRef<"Favorite", 'String'>
